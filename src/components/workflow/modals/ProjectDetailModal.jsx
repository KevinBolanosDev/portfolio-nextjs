...
function DetailBody({ project, onClose }) {
  ...
  useEffect(() => {
    // Captura + stopImmediatePropagation: el Esc cierra SOLO este
    // modal, sin llegar al listener del ModalShell de Projects.
                  ...
                  {gallery.map((item, index) => {
                    ...
                    return (
                      <div
                        ...
                        className={`group/slide relative h-44 shrink-0 overflow-hidden rounded-xl border border-[rgba(76,139,245,0.25)] bg-[#0F1A2E] sm:h-56 ${
                          isMobile
                            ? "w-[128px] sm:w-[160px]"
                            : "w-[280px] sm:w-[360px]"
                        }`}
                      >
                        ...
                        />
                        <div className="absolute inset-0 flex flex-col justify-end bg-gradient-to-t from-[#050A18]/90 via-transparent to-transparent p-3 opacity-0 transition-opacity duration-300 group-hover/slide:opacity-100">
